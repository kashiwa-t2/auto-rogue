...
func update_display() -> void:
	...
	_log_debug("Display updated - Character Lv: %d, Attack Speed Lv: %d, Potion Lv: %d, Coins: %d" % 
		[PlayerStats.character_level, PlayerStats.attack_speed_level, PlayerStats.potion_effect_level, PlayerStats.total_coins])
